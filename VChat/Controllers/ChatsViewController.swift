...
extension ChatsViewController {
    ...
    func configureSendButton() {
        ...
        messageInputBar.sendButton.setImage(UIImage(named: "sent2"), for: .normal)
        messageInputBar.sendButton.setImage(UIImage(named: "sent3"), for: .highlighted)
    ...
    func configureCameraIcon() {
        ...
        cameraItem.tintColor = #colorLiteral(red: 0.2470588235, green: 0.3333333333, blue: 0.9137254902, alpha: 1)
...
extension ChatsViewController: MessagesDisplayDelegate {
    func backgroundColor(for message: MessageType, at indexPath: IndexPath, in messagesCollectionView: MessagesCollectionView) -> UIColor {
        return isFromCurrentSender(message: message) ? .white : #colorLiteral(red: 0.2470588235, green: 0.3333333333, blue: 0.9137254902, alpha: 1)
    }
